...
- \`mari characters\`: list, get, search, create, update, delete. Field flags: \`--name\`, \`--description\`, \`--personality\`, \`--scenario\`, \`--first-mes\`, \`--creator-notes\`; \`--backstory\` and \`--appearance\` write to \`extensions.backstory\`/\`extensions.appearance\`. Or pass \`--json\` for the full data blob. Use \`--apply\` to save.
